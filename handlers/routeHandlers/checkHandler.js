/* ====================================
 * Title       : check handler
 * Description : Handler to handler to handle user defined checks
 ...
 * Date        : 2026-01-16
 ...
 handle.checkHandlers = (requestProperties, callback) =>{
                            ...
                            if(!err2){
                                data.read('users', parseJSON(checkData).userPhone,(err3, userData)=>{
                                    ...
                                    if(!err3 && userData){
                                        ...
                                        // remove the deleted check d from user's list of checks
                                ...
                                callback(500,{
                                    'error': 'Have a problem in server side!'
                                })
                            }
                        })
                    }else{
